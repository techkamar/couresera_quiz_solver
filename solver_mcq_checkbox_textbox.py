...
class CourseEraSolver:
    ...
    def get_regex_sub_entry(self,entry,question_id,question):
        # Put Random answer to TextBox entry
        sub_entry = {
            "questionInstance": question_id,
            "response": {
                "answer": "A"
    ...
    def get_send_question_payload(self, data):
        ...
        for entry in data:
            ...
            if question_type=="mcq":
                ...
                # Textbox entry. Skip it
                print("--Skipping Regex -- Adding dummy answer")
                sub_entry ={"questionInstance": question_id,"response": {"answer": "A"}}
    ...
    def mark_right_answers(self, parts):
        for current in parts:
            ...
            if 'chosen' in current['definition']['effectiveResponse']['response']: 
